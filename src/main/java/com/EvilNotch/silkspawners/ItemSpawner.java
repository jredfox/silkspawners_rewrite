...
public class ItemSpawner extends ItemBlock{
	...
	public static void populateCustomSpawnerEntries(List<ItemStack> stacks) {
    	...
    	sheep.setTagCompound(NBTUtil.getNBTFromString("{MaxNearbyEntities:6s,RequiredPlayerRange:16s,SpawnCount:4s,display:{EntName:\"entity.Sheep.name\",EntColor:\"§d\"},silkTag:\"minecraft:sheep\",SpawnData:{CustomName:\"jeb_\",id:\"minecraft:sheep\"},MaxSpawnDelay:800s,SpawnRange:4s,Delay:20,MinSpawnDelay:200s,SpawnPotentials:[{Entity:{CustomName:\"jeb_\",id:\"minecraft:sheep\"},Weight:1}]}"));
    	...
    	killerrabbit.setTagCompound(NBTUtil.getNBTFromString("{MaxNearbyEntities:6s,RequiredPlayerRange:16s,SpawnCount:4s,display:{EntName:\"silkspawners.killerrabbit.name\",EntColor:\"§d\"},silkTag:\"minecraft:rabbit\",SpawnData:{RabbitType:99,id:\"minecraft:rabbit\"},MaxSpawnDelay:800s,SpawnRange:4s,Delay:20,MinSpawnDelay:200s,SpawnPotentials:[{Entity:{RabbitType:99,id:\"minecraft:rabbit\"},Weight:1}]}"));
